...
# 4. Log in to Kimi Code (Moonshot)
...
That lasts until the container restarts. See [Network allowlist](05-network-allowlist.md).
...
Next: **[Network allowlist](05-network-allowlist.md)**
